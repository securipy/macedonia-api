...
--
-- Servidor: localhost
-- Tiempo de generación: 26-11-2016 a las 06:44:09
...
--
-- Estructura de tabla para la tabla `aws_credentials`
--
...
--
-- Estructura de tabla para la tabla `devices_files_nmap`
--
...
--
-- Estructura de tabla para la tabla `devices_ports`
--
...
--
-- Estructura de tabla para la tabla `script_work`
--
...
--
-- Estructura de tabla para la tabla `servers_scripts`
--
...
--
-- Estructura de tabla para la tabla `user_url_access`
--
...
--
-- Volcado de datos para la tabla `user_url_access`
--
...
--
-- Estructura de tabla para la tabla `wifi_data`
--
...
--
-- Estructura de tabla para la tabla `xrequests_urls`
--
...
--
-- Estructura de tabla para la tabla `xrequests_urls_client`
--
...
--
-- Indices de la tabla `aws_credentials`
--
...
--
-- Indices de la tabla `devices_files_nmap`
--
ALTER TABLE `devices_files_nmap`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `devices_ports`
--
...
--
-- Indices de la tabla `script_work`
--
...
--
-- Indices de la tabla `servers_scripts`
--
...
--
-- Indices de la tabla `user_url_access`
--
ALTER TABLE `user_url_access`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `wifi_data`
--
...
--
-- Indices de la tabla `xrequests_urls`
--
...
--
-- AUTO_INCREMENT de la tabla `aws_credentials`
--
ALTER TABLE `aws_credentials`
...
ALTER TABLE `devices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `devices_files_nmap`
--
ALTER TABLE `devices_files_nmap`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `devices_ports`
--
ALTER TABLE `devices_ports`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `script_work`
--
ALTER TABLE `script_work`
...
ALTER TABLE `servers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `servers_scripts`
--
ALTER TABLE `servers_scripts`
...
--
-- AUTO_INCREMENT de la tabla `user_url_access`
--
ALTER TABLE `user_url_access`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `wifi_data`
--
ALTER TABLE `wifi_data`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `xrequests_urls`
--
ALTER TABLE `xrequests_urls`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Filtros para la tabla `servers_scripts`
--
ALTER TABLE `servers_scripts`
...
--
-- Filtros para la tabla `wifi_data`
--
ALTER TABLE `wifi_data`
